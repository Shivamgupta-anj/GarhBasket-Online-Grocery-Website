  ...
  return (
    <div className='bg-linear-to-b from-white to-gray-100 min-h-screen w-full' >
        ...
        <div className='max-w-3xl mx-auto px-4 pt-16 pb-10 relative'>
            ...
            <div className='fiexd top-0 left-0 w-full backdrop-blur-lg bg-white/70 shadow-sm border-b z-50'>

            <div className='max-w-3xl mx-auto flex items-center gap-4 px-4 py-3'>

                <button className='p-2 bg-gray-100 rounded-full hover:bg-gray-200 active:scale-95 transiton' onClick={()=>router.push("/")}>
            ...
            {orders?.length==0?(
                <div className='pt-20 flex flex-col items-center text-center'>
                    ...
                    <PackageSearch size={70} className='text-gray-600 mb-4'/>
