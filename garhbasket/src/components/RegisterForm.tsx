...
function RegisterForm({previousStep}:propType) {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
        ...
        <p className='text-gray-600 mb-8 flex items-center'>
            Join GarhBasket today and get exclusive deals and offers!
  ...
  "Create Account"
            ...
            <div className='w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 py-3 rounded-xl text-gray-700 font-medium transition-colors duration-200' onClick={()=>signIn("google",{callbackUrl:"/"})}>
