  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-50 to-white">
        ...
        >
            ...
            <h1 className='text-4xl md:text-5xl font-extrabold text-green-700'>Garhbasket</h1>
            </motion.div>
            ...
            >
                Say goodbye to grocery runs with GarhBasket. Order fresh fruits, vegetables, snacks, and daily essentials from the comfort of your home. We deliver quickly, reliably, and right to your door. Making your everyday life easier, one order at a time.
            ...
            >
                <ShoppingBasket className='w-24 h-24 md:w-32 md:h-32 md:h-32 text-green-600 drop-shadow-md'/>
                <Bike className='w-24 h-24 md:w-32 md:h-32 md:h-32 text-orange-600 drop-shadow-md'/>
